...
const PatientChat = {
        ...
        <div class="chat-layout">
            <div class="chat-sidebar">
                <div class="chat-sidebar-header">
                    <h3>医生列表</h3>
                    <el-input v-model="searchText" placeholder="搜索医生..." size="small" clearable />
                </div>
    ...
    setup() {
        ...
        Vue.onMounted(async () => {
            ...
            // Load doctors and add to contacts
            try {
                ...
                doctorList.forEach(d => {
                    ...
                    if (!contact) {
                        chatStore.contacts.push({
                            username: username,
                            real_name: d.real_name || username,
                            lastMsg: '',
                            unread: 0,
                            online: false,
                        ...
                        // 更新 real_name
                        contact.real_name = d.real_name || username;
                    }
                });
        ...
        const filteredContacts = Vue.computed(() => {
            ...
            return list.filter(d =>
                d.username.includes(searchText.value) ||
                (d.real_name && d.real_name.includes(searchText.value)) ||
                (d.department && d.department.includes(searchText.value))
            );
        });
